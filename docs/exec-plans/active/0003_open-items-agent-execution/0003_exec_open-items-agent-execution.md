...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| M1: Contract | 01–03 | pending | Serialization amendment decided and normative docs conform | rg checks on ADR-0008 + backend ref + governance rule | Label vocabulary + slugs fully specified; no design decisions left downstream | `docs(open-items): ...` |
